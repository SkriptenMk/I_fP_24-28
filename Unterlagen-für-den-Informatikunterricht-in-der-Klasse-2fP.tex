...
dem GitHub-Logo
\pandocbounded{\includegraphics[keepaspectratio]{files/octocat_klein.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/files/260611_trigonometrie/dreieck.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/files/260611_trigonometrie/vermessung.pdf}}
...
\(\alpha_1\), \(\alpha_2\), \(\beta_1\) und \(\beta_2\).
...
\item
  ...
  \(a = \frac{s \cdot \sin \alpha_1}{\sin \gamma_1}\)
\item
  \(\gamma_2 = 180^{\circ} - (\alpha_2 + \beta_2)\)
\item
  Mit Hilfe des Sinussatzes
  \(b = \frac{s \cdot \sin \alpha_2}{\sin \gamma_2}\)
\item
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/files/260611_trigonometrie/circle.pdf}}
...
\begin{Shaded}
\begin{Highlighting}[numbers=left,,]
\KeywordTok{def}\NormalTok{ angleconverter(angle: }\BuiltInTok{float}\NormalTok{, a: }\BuiltInTok{bool} \OperatorTok{=} \VariableTok{False}\NormalTok{, gon: }\BuiltInTok{bool} \OperatorTok{=} \VariableTok{False}\NormalTok{) }\OperatorTok{{-}\textgreater{}} \BuiltInTok{float}\NormalTok{:}
...
\CommentTok{        a (bool, optional): Wenn True, wird der Winkel als Artillerie{-}Promille}
...
\CommentTok{    Raises:}
\CommentTok{        ValueError: Wenn sowohl \textquotesingle{}a\textquotesingle{} als auch \textquotesingle{}gon\textquotesingle{} auf True gesetzt sind.}
\CommentTok{    """}
    \ControlFlowTok{if}\NormalTok{ a }\KeywordTok{and}\NormalTok{ gon:}
        \ControlFlowTok{raise} \PreprocessorTok{ValueError}\NormalTok{(}
            \StringTok{"Es kann nur \textquotesingle{}a=True\textquotesingle{} (Artillerie) ODER \textquotesingle{}gon=True\textquotesingle{} gewählt werden."}
\NormalTok{        )}
...
\item
  Falls \(r\) negativ ist, einmal 360 addieren: \(r+360\)
\end{enumerate}
...
\begin{Shaded}
\begin{Highlighting}[numbers=left,,]
\KeywordTok{def}\NormalTok{ sine\_rule(length: }\BuiltInTok{float}\NormalTok{, angle1: }\BuiltInTok{float}\NormalTok{, angle2: }\BuiltInTok{float}\NormalTok{) }\OperatorTok{{-}\textgreater{}} \BuiltInTok{float}\NormalTok{:}
    \ControlFlowTok{return}\NormalTok{ (length }\OperatorTok{*}\NormalTok{ math.sin(angle1)) }\OperatorTok{/}\NormalTok{ math.sin(angle2)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{                  alpha1\_a: }\BuiltInTok{float}\NormalTok{,}
\NormalTok{                  alpha1\_b: }\BuiltInTok{float}\NormalTok{,}
\NormalTok{                  alpha2\_a: }\BuiltInTok{float}\NormalTok{,}
\NormalTok{                  alpha2\_b: }\BuiltInTok{float}\NormalTok{,}
\NormalTok{                  beta1\_a: }\BuiltInTok{float}\NormalTok{,}
\NormalTok{                  beta1\_b: }\BuiltInTok{float}\NormalTok{,}
\NormalTok{                  beta2\_a: }\BuiltInTok{float}\NormalTok{,}
\NormalTok{                  beta2\_b: }\BuiltInTok{float}\NormalTok{,}
\NormalTok{                  a: }\BuiltInTok{bool} \OperatorTok{=} \VariableTok{False}\NormalTok{, }
\NormalTok{                  gon: }\BuiltInTok{bool} \OperatorTok{=} \VariableTok{False}\NormalTok{) }\OperatorTok{{-}\textgreater{}} \BuiltInTok{float}\NormalTok{:}
\NormalTok{    input\_angles }\OperatorTok{=}\NormalTok{ [alpha1\_a, alpha1\_b, alpha2\_a, alpha2\_b, beta1\_a, beta1\_b, beta2\_a, beta2\_b]}
\NormalTok{    angles }\OperatorTok{=}\NormalTok{ []}
    \ControlFlowTok{for}\NormalTok{ i }\KeywordTok{in} \BuiltInTok{range}\NormalTok{(}\DecValTok{0}\NormalTok{, }\BuiltInTok{len}\NormalTok{(input\_angles)}\OperatorTok{{-}}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{):}
...
\NormalTok{    i }\OperatorTok{=} \DecValTok{0}
    \ControlFlowTok{for}\NormalTok{ angle }\KeywordTok{in}\NormalTok{ angles:}
\NormalTok{        angles[i] }\OperatorTok{=}\NormalTok{ anlgeconverter(angle, a, gon)}
        
\NormalTok{    alpha1, alpha2, beta1, beta2 }\OperatorTok{=}\NormalTok{ angles}
...
\NormalTok{    a }\OperatorTok{=}\NormalTok{ sine\_rule(s, alpha1, gamma1)}
\NormalTok{    b }\OperatorTok{=}\NormalTok{ sine\_rule(s, alpha2, gamma2)}
    
\NormalTok{    l }\OperatorTok{=}\NormalTok{ math.sqrt(a}\OperatorTok{**}\DecValTok{2}\OperatorTok{+}\NormalTok{b}\OperatorTok{**}\DecValTok{2}\OperatorTok{{-}}\DecValTok{2}\OperatorTok{*}\NormalTok{a}\OperatorTok{*}\NormalTok{b}\OperatorTok{*}\NormalTok{math.cos(beta2}\OperatorTok{{-}}\NormalTok{beta1))}
...
\pandocbounded{\includegraphics[keepaspectratio]{files/250919_vigenere/vigenere_files/figure-pdf/cell-2-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{files/250919_vigenere/vigenere_files/figure-pdf/cell-3-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/files/250919_vigenere/vigenere_square_shading.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{files/250919_vigenere/vigenere_files/figure-pdf/cell-4-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/files/251031/graph0.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/files/251031/graph1.pdf}}

Nach der Addition der Nachbarn stellt sich der Graph folgendermassen
dar:

\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/files/251031/graph2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/files/251031/graph_d.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{files/250829/ws_start_window.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{files/250829/ws_anzeigefilter.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{files/250829/ws_dns_query.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{files/250829/ws_selected_package.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{files/250829/schema_three-way-handshake.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{files/250829/ws_ip-addr-Filter.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{files/250829/ws_three-way-handshake.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/files/250416/er_example_klein.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/files/250416/er_example_gross.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/files/250416/entity_class.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/files/250416/entity_subject.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/files/250416/entity_teacher.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/files/250507/relationship_cut.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/files/250219/class_diagram.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/KKsN5DtWRIAAAAASUVOR.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/files/250319/tabelle.pdf}}
